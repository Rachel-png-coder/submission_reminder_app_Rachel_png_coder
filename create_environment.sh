...
echo 'syveta, Shell Navigation, not submitted
rachel, Shell Navigation, submitted
strive, Shell Navigation, submitted
ester, Shell Navigation, not submitted
yvet, Shell Navigation, submitted' >> ./assets/submissions.txt
